        ...
        <div className="flex-1 overflow-y-auto px-3 pb-4">
          ...
          {users.map((profile) => (
            <div
              key={profile._id}
              onClick={() => {
                setSelectedUser(profile.mentor?profile.mentor?._id:profile.user?._id);
              ...
              className={`
                ...
                hover:bg-white/20
                ${
                  selectedUser === profile.mentor?profile.mentor?._id:profile.user?._id
