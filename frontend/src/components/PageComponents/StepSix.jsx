...
function StepSix({nextStep,prevStep,formdata,setFormdata}) {
     const {register,handleSubmit,formState:{errors}}=useForm({defaultValues:{
        title:formdata.steps[4].title,
        description:formdata.steps[4].description,
        checklist:formdata.steps[4].checklist,
        resources:formdata.steps[4].resources,
        mentortips:formdata.steps[4].mentortips,
    }});
    const onSubmit=(data)=>{
        
        const updateSteps=[...formdata.steps];
        updateSteps[4]={...updateSteps[4],...data};
