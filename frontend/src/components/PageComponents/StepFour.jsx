...
function StepFour({nextStep,prevStep,formdata,setFormdata}) {
   const {register,handleSubmit,formState:{errors}}=useForm({defaultValues:{
           title:formdata.steps[2].title,
        description:formdata.steps[2].description,
        checklist:formdata.steps[2].checklist,
        resources:formdata.steps[2].resources,
        mentortips:formdata.steps[2].mentortips,
    }});
    const onSubmit=(data)=>{
        
        const updateSteps=[...formdata.steps];
        updateSteps[2]={...updateSteps[2],...data};
