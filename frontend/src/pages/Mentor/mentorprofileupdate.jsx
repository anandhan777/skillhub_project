...
function Mentorprofileupdate() {
  ...
  return (
    <motion.div initial={{scale:0,opacity:0}} animate={{scale:1,opacity:1}} transition={{duration:0.5}}><MentorProfileForm title="update" formData={formData} handleChange={handleChange} handleSubmit={handleSubmit} preview1={preview1} preview2={preview2}/></motion.div>
  )
}
