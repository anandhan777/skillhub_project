...
function ViewUserProfile() {
  ...
  return (
    <div>
        ...
        <h3 className='text-2xl text-gray-500 flex items-center'><MdLocationOn/>{profile.location}</h3>
        ...
        <div className="flex mt-4 gap-4">
            <button onClick={handleClick} className=" border-2 border-blue-400 bg-transparent text-blue-800 px-4 py-2 rounded-full hover:text-white duration-500 hover:bg-blue-800">connect</button>
            </div>
